...
public class BlockTags {
    ...
    public static final TagKey<Block> WOOL = SneakyUtil.sneakyNotNull();
    public static final TagKey<Block> MINEABLE_WITH_AXE = SneakyUtil.sneakyNotNull();
    public static final TagKey<Block> MINEABLE_WITH_HOE = SneakyUtil.sneakyNotNull();
    ...
    public static final TagKey<Block> LEAVES = SneakyUtil.sneakyNotNull();
}
